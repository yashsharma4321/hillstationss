...
@section('header', 'Edit Collection: ' . $collection->heading)
...
<div class="content-card">
    ...
    <form action="{{ route('admin.collections.update', $collection) }}" method="POST" enctype="multipart/form-data" style="padding: 2rem;">
        @csrf
        @method('PUT')
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
            ...
            <div>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" name="heading" id="heading" value="{{ old('heading', $collection->heading) }}" required 
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    @if($collection->image)
                        <div style="margin-bottom: 0.5rem;">
                            <img src="{{ Storage::url($collection->image) }}" style="width: 100px; height: 100px; object-fit: cover; border-radius: 0.5rem;">
                        </div>
                    @endif
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <textarea name="description" rows="4" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: 0.5rem; font-family: inherit; font-size: 0.875rem;">{{ old('description', $collection->description) }}</textarea>
                </div>
            </div>
            ...
            <div>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title', $collection->meta_title) }}" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: 0.5rem; font-family: inherit; font-size: 0.875rem;">
                </div>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $collection->meta_keywords) }}" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: 0.5rem; font-family: inherit; font-size: 0.875rem;">
                </div>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <textarea name="meta_description" rows="3" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: 0.5rem; font-family: inherit; font-size: 0.875rem;">{{ old('meta_description', $collection->meta_description) }}</textarea>
                </div>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <textarea name="meta_schema" rows="3" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border); border-radius: 0.5rem; font-family: inherit; font-size: 0.875rem; font-family: monospace;">{{ old('meta_schema', $collection->meta_schema) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div style="display: flex; gap: 1rem; justify-content: flex-end; border-top: 1px solid var(--border); padding-top: 1.5rem;">
            ...
            <button type="submit" style="padding: 0.75rem 2rem; background: var(--primary); border: none; color: white; border-radius: 0.5rem; font-weight: 600; cursor: pointer;">Update Collection</button>
        </div>
    </form>
</div>
@endsection
