    ...
    <form method="GET" action="{{ route('vendor.bookings') }}">
        <div style="padding: 1.25rem 1.75rem; background: #f8fafc; border-bottom: 1px solid var(--border); display: flex; flex-wrap: wrap; gap: 1rem; align-items: flex-end;">
            ...
            <div style="display:flex; gap:0.5rem; align-items:flex-end;">
                ...
                <a href="{{ route('vendor.bookings') }}" style="padding: 0.55rem 1.25rem; border-radius: 0.75rem; font-weight: 600; font-size: 0.875rem; cursor: pointer; border: 1px solid var(--border); font-family: 'Outfit', sans-serif; background: #f1f5f9; color: var(--text-main); text-decoration: none; display: inline-flex; align-items: center;">✕ Reset</a>
            </div>
        </div>
    </form>
